...
import com.example.proyectofinalrestaurante.data.sync.SincronizadorCliente;
...
import com.example.proyectofinalrestaurante.data.sync.SincronizadorMesa;
...
public final class SyncApplication extends Application implements Configuration.Provider {
    ...
    private static final class FactoryDeSync extends WorkerFactory {
        ...
        public ListenableWorker createWorker(@NonNull Context contexto,
            ...
            Sincronizador mesas = new SincronizadorMesa(mesaRemoto,
            ...
            Sincronizador clientes = new SincronizadorCliente(clienteRemoto,
