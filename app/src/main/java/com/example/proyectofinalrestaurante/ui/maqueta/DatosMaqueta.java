 ...
 *
 * <p>Los estados de pedido están acá y no en {@code domain} a propósito: el
 ...
 *
 * <p>Las mesas y sus estados ya tienen modelo real en {@code domain.model.EstadoMesa}
 * y se leen de Room (Fase 2c). Los clientes ya tienen modelo real en
 * {@code domain.model.Cliente} y se leen de Room (Fase 2d).</p>
 */
